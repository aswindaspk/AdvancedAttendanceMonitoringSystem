...
class _AttendanceNewState extends State<AttendanceNew> {
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(
                        builder: (context) => SubjectAttendance(title: '',),));
                    },
  ...
  void getdata() async {
    ...
    final urls = Uri.parse('$url/student_view_attendance/');
  ...
  void getmonthly() async {
    ...
    String url = sh.getString('url').toString();
    String lid = sh.getString('lid').toString();
    final urls = Uri.parse('$url/student_attendance_month/');
  ...
  void gettotal() async {
    ...
    String url = sh.getString('url').toString();
    String lid = sh.getString('lid').toString();
    final urls = Uri.parse('$url/student_attendance_total/');
