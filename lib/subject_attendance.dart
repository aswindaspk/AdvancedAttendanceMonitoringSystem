...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SubjectAttendance(title: 'Subject-wise Attendance'),
    );
  }
}

class SubjectAttendance extends StatefulWidget {
  const SubjectAttendance({super.key, required this.title});
...
class _SubjectAttendanceState extends State<SubjectAttendance> {
  ...
  Future<void> view_notification() async {
    ...
    try {
      ...
      String url = '$urls/student_attendance_subject/';
